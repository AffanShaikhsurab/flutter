  ...
  Widget _secondaryAnimatedBuilder(BuildContext context, Widget? child) {
    ...
    return Transform.translate(
      ...
      child: Transform.scale(
        ...
        child: Opacity(
            opacity: fadeTween.animate(secondaryAnimation).value, child: child),
      ),
    );
  }
  ...
  Widget _primaryAnimatedBuilder(BuildContext context, Widget? child) {
    ...
    return Transform.translate(
      ...
      child: Transform.scale(
        ...
        child:
            Opacity(opacity: fadeTween.animate(animation).value, child: child),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      child: AnimatedBuilder(
          animation: animation, builder: _primaryAnimatedBuilder, child: child),
    );
  }
}
