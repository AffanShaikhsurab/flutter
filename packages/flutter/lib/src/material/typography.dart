...
class Typography with Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
      DiagnosticsProperty<TextTheme>('black', black,
          defaultValue: defaultTypography.black),
    );
    properties.add(
      DiagnosticsProperty<TextTheme>('white', white,
    ...
    properties.add(
      DiagnosticsProperty<TextTheme>('dense', dense,
          defaultValue: defaultTypography.dense),
    );
    properties.add(
      DiagnosticsProperty<TextTheme>('tall', tall,
