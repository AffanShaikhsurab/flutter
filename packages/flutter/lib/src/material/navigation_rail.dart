...
class _NavigationRailState extends State<NavigationRail>
  ...
  void _initControllers() {
    _destinationControllers =
        List<AnimationController>.generate(widget.destinations.length, (
      int index,
    ) {
    ...
    _extendedAnimation =
        CurvedAnimation(parent: _extendedController, curve: Curves.easeInOut);
...
class _RailDestinationState extends State<_RailDestination> {
  ...
  Widget build(BuildContext context) {
    ...
    final EdgeInsets destinationPadding =
        (widget.padding ?? EdgeInsets.zero).resolve(
      textDirection,
    );
    ...
    switch (widget.labelType) {
              ...
              children: <Widget>[
                ...
                SizedBox.shrink(
                    child: Visibility.maintain(
                        visible: false, child: widget.label)),
              ],
            ),
          );
        } else {
          final Animation<double> labelFadeAnimation =
              widget.extendedTransitionAnimation.drive(
      ...
      case NavigationRailLabelType.selected:
        ...
        final Animation<double> labelFadeAnimation =
            widget.destinationAnimation.drive(
        ...
        content = ConstrainedBox(
          constraints:
              BoxConstraints(minWidth: widget.minWidth, minHeight: minHeight),
          child: Padding(
...
class _AddIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
        alignment: Alignment.center, children: <Widget>[indicator, child]);
  }
}
...
class _ExtendedNavigationRailAnimation extends InheritedWidget {
  const _ExtendedNavigationRailAnimation(
      {required this.animation, required super.child});
