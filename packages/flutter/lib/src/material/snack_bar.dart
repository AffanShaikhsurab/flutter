...
class _SnackBarState extends State<SnackBar> {
  ...
  Widget build(BuildContext context) {
              ...
              Expanded(
                child: Padding(
                  ...
                  child: DefaultTextStyle(
                      style: contentTextStyle!, child: widget.content),
                ),
              ),
    ...
    if (accessibleNavigation) {
      ...
      snackBarTransition =
          FadeTransition(opacity: _fadeInAnimation!, child: snackBar);
    ...
    return Hero(
      ...
      child: ClipRect(
          clipBehavior: widget.clipBehavior, child: snackBarTransition),
    );
  }
}
