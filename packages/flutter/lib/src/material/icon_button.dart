...
class IconButton extends StatelessWidget {
  ...
  static ButtonStyle styleFrom({
    ...
    if ((hoverColor ?? focusColor ?? highlightColor ?? overlayFallback) !=
        null) {
  ...
  Widget build(BuildContext context) {
    ...
    final BoxConstraints adjustedConstraints =
        effectiveVisualDensity.effectiveConstraints(
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ObjectFlagProperty<ValueChanged<bool>>('onHover', onHover,
        ifNull: 'disabled'));
    properties.add(
      ObjectFlagProperty<VoidCallback>('onLongPress', onLongPress,
          ifNull: 'disabled'),
    );
